...
public class MyDiscordWebhook {
     ...
     */
    public MyDiscordWebhook(String url) {
        this.url = url;
    }

    public MyDiscordWebhook setContent(String content) {
        this.content = content;
        return this;
    }

    public MyDiscordWebhook setUsername(String username) {
        this.username = username;
        return this;
    }

    public MyDiscordWebhook setAvatarUrl(String avatarUrl) {
        this.avatarUrl = avatarUrl;
        return this;
    }

    public MyDiscordWebhook setTts(boolean tts) {
        this.tts = tts;
        return this;
    }

    public MyDiscordWebhook addEmbed(EmbedObject embed) {
        if (file != null) {
    ...
    public MyDiscordWebhook addFile(File file) {
        if (!embeds.isEmpty()) {
            throw new IllegalArgumentException("File upload not supported with embeds");
        }
        this.file = file;
    ...
    public File takeScreenShotAndSave(String path){
